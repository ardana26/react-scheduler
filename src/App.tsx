...
function App() {
  const [values, setValues] = useState<ConfigFormValues>({
    ...
    yearsCovered: 0,
    // startDate: undefined,
    startDate: "2024-07-01T10:30:00.000Z",
    ...
    data: [
      {
        ...
        startDate: new Date("2024-07-02T10:30:00.000Z"),
        endDate: new Date("2024-07-02T11:00:00.000Z"),
        occupancy: 3600,
        title: "Daily",
        subtitle: "Subtitle A",
      ...
      },
      {
        ...
        startDate: new Date("2024-07-02T15:30:00.000Z"),
        endDate: new Date("2024-07-02T16:00:00.000Z"),
        occupancy: 2852,
        title: "retro",
        subtitle: "Subtitle B",
